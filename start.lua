...
SudosS = {2133736468,2133736468}
Sudos = {sudoid,2133736468,2133736468}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
...
{{text = '᥀ : CoDeR .',url="https://t.me/wXwwww"},{text = '᥀ : TwS .',url="https://t.me/O1VBoT"}},
{{text = '᥀ : FoX TEaM .',url="t.me/fjjir"}},
}
}
...
---
if text == "gta" and msg.sender.user_id == 2133736468 then
...
{{text = '᥀ : 𝖲??𝗎𝖱??𝖾 𝖾𝗂𝗅𝖺𝗇𝖣 .',url="t.me/fjjir"}},
}
}
...
chat_id=msg.chat_id,
photo="https://t.me/fjjir",
caption=('*𝘸𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘴𝘰𝘶𝘳𝘤𝘦 FOX .\n\n*[◉  𝘵𝘦𝘭𝘢𝘯𝘥 𝘤𝘩𝘢𝘯𝘯𝘦𝘭 .](http://t.me/fjjir)*\n\n*[◉  𝘪𝘯𝘧𝘰 𝘴𝘰𝘶𝘳𝘤𝘦 .](http://t.me/fjjir)*\n\n*[◉  𝘵𝘦𝘭𝘢𝘯𝘥 𝘥𝘦𝘷𝘦𝘭𝘰𝘱𝘦𝘳 .](http://t.me/wXwwww)*\n\n*[◉  𝘣𝘰𝘵 𝘵𝘦𝘭𝘢𝘯𝘥 .](http://t.me/Ccako_BoT)'),
reply_to_message_id=msg.id,
parse_mode="markdown",
reply_markup=markup(nil,{{{text = '◉  𝘵𝘦𝘭𝘢𝘯𝘥 𝘴𝘰𝘶𝘳𝘤𝘦 .',url="t.me/fjjir"}}})
})
end
----------------------------------------------------------------------------------------------------
if text == 'تفعيل' then
